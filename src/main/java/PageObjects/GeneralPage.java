...
public class GeneralPage {
    ...
    protected WebElement getlbChangePassword() {
        return Constant.WEBDRIVER.findElement(lbChangePassword);
    }

    protected WebElement getTimeTablebnt() {
        return Constant.WEBDRIVER.findElement(TimeTablebnt);
    }

    protected WebElement getMyTicketbnt() {
        return Constant.WEBDRIVER.findElement(MyTicketbnt);
    }
    ...
    public void gotoMyTicket() {
        this.getMyTicketbnt().click();
    }

    public String getSeatTypePrice(String seatType) {
        return this.getlblPrice(seatType).getText();
    }
}
