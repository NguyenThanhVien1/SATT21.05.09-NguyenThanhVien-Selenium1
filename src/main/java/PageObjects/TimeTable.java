...
public class TimeTable extends GeneralPage{
    ...
    //Elemnets
    protected WebElement getBookticketinTable(){return Constant.WEBDRIVER.findElement(BookticketinTable);}
    ...
    //method
    public void Bookticket(){this.getBookticketinTable().click();}
