...
public class FTTC202 extends TestBase {
    ...
    public void FTTC201( String departStation, String arriveStation, String seatType, String ticketAmount,
        ...
        System.out.println("5. Select one of booked Depart Station in 'Arrive Station' dropdown list");
        System.out.println("6. Click 'Apply filter' button");
        bookTicket.clickCbbArriveStation();
        String actualMsg1 = myTicket.getArriveStationDisplay();
        String expectedMsg1 = arriveStation2;
        Assert.assertEquals(actualMsg1, expectedMsg1, "'Manage ticket' table shows correct ticket(s)");
